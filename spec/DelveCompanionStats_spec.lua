...
describe("DelveCompanionStats", function()
    ...
    describe("companion name lookup table", function()
        ...
        it("has entries for all four known companions", function()
            assert.is_not_nil(ns.companionNames[1])
            assert.is_not_nil(ns.companionNames[2])
            assert.is_not_nil(ns.companionNames[3])
            assert.is_not_nil(ns.companionNames[4])
        end)
    end)
