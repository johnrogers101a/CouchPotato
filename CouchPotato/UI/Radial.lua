...
local INTERFACE_WHEEL_LAYOUTS = {
    [1] = {
        ...
        slots = {
            ...
            [4]  = { name="Map",          macro="/click WorldMapMicroButton",       icon="Interface\\Buttons\\UI-MicroButton-WorldMap-Up",     execute=function() WorldMapFrame:SetShown(not WorldMapFrame:IsShown()) end },
    ...
    [2] = {
        ...
        slots = {
            ...
            [8]  = { name="World Map",   macro="/click WorldMapMicroButton",       icon="Interface\\Buttons\\UI-MicroButton-WorldMap-Up",     execute=function() WorldMapFrame:SetShown(not WorldMapFrame:IsShown()) end },
